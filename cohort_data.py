def unique_houses(filename):
    ...
    for line in cohort_file:
        cohort_data = line.rstrip().split('|')
        house = cohort_data[2]

        if house == "":
            continue
        else:
            houses.append(cohort_data[2])
...
def sort_by_cohort(filename):
    ...
    house_mappings = {
        "Winter 2016": winter_16,
        "Fall 2015": fall_15,
        "Spring 2016": spring_16,
        "G": ghosts,
        "I": instructors,
        "Summer 2016": summer_16,
        }
    ...
    for line in cohort_file:
        cohort_data = line.rstrip().split('|')
        first_name, last_name, house, advisor, cohort = cohort_data
        name = " ".join([first_name, last_name])
        house_mappings[cohort].append(name)
    ...
    all_students.extend([winter_16, spring_16, summer_16, ghosts, fall_15])
